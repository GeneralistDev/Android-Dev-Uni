...
\bigskip
\centering{
	\fbox{\includegraphics[width=6cm]{images/screenshot-values.png}}
}\\
\bigskip
\centering{
	\fbox{\includegraphics[width=6cm]{images/screenshot-english.png}}
}\\
\bigskip
\centering{
	\fbox{\includegraphics[width=6cm]{images/screenshot-spanish.png}}
}\\
\bigskip
