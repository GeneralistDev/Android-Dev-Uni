package au.net.danielparker.suntime.calc;
...
public class AstronomicalCalendar
{
	 ...
	 * @see au.net.danielparker.suntime.calc.AstronomicalCalendar#getSunrise
	 * @see au.net.danielparker.suntime.calc.AstronomicalCalendar#getUTCSeaLevelSunrise
	 */
	 ...
	 *         not rise, and one where it does not set, a null will be returned.
	 *         See detailed explanation on top of the page.
	 * @see au.net.danielparker.suntime.calc.AstronomicalCalendar#getSunset
	 * @see au.net.danielparker.suntime.calc.AstronomicalCalendar#getUTCSeaLevelSunset
	 */
	 ...
	 * {@link #getTimeOffset(java.util.Date, long)}.
	 * 
	 * @param time
	 *            the start time
	 * @param offset
	 ...
	 *         one where it does not set, {@link Double#NaN} will be returned.
	 *         See detailed explanation on top of the page.
	 * @see au.net.danielparker.suntime.calc.AstronomicalCalendar#getUTCSunrise
	 * @see au.net.danielparker.suntime.calc.AstronomicalCalendar#getUTCSeaLevelSunset
	 */
	 ...
	 *         one where it does not set, {@link Double#NaN} will be returned.
	 *         See detailed explanation on top of the page.
	 * @see au.net.danielparker.suntime.calc.AstronomicalCalendar#getUTCSunset
	 * @see au.net.danielparker.suntime.calc.AstronomicalCalendar#getUTCSeaLevelSunrise
	 */
